        ...
        <div className='flex flex-wrap'>
          <div className='w-full self-center px-4 lg:w-1/2 '>
            ...
            <h2 className='font-medium text-slate-500 text-lg mb-5 lg:text-2xl'>
              Web Develover & <span className='text-dark'> Freelancer </span>
            </h2>
            <p className='font-medium text-slate-400 mb-10 leading-relaxed'>
              Belajar Web Itu pusing bukan ? <span className='text-dark font-bold'>Yaaa !</span>
            </p>
            <a
              href='/tiket'
          ...
          <div className='w-full self-end px-4 lg:w-1/2'>
            <div className='relative mt-10 lg:mt-0 lg:right-0'>
              <img src={gambar} alt='railan' className='max-w-full mx-auto' />
